        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://www.instagram.com/elina.soblr/" className="text-gray-300 hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="https://www.linkedin.com/search/results/all/?keywords=Syena%20Kitchenconceptz%20Mfg%20Pvt%20Ltd%20(%20elina.so)&sid=_ZS" className="text-gray-300 hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex">
                ...
                <span className="text-gray-300">info@elina.so</span>
              </li>
            </ul>
          </div>
        </div>
