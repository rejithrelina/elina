      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p>
              At Syena Kitchenconceptz Manufacturing Private Limited ("we," "us," or "our"), we respect your privacy and
            ...
            <ul>
              <li>
                ...
                contact details you provide when filling out forms on our website.
              </li>
              <li>
                <strong>Usage Information:</strong> Information about how you use our website, including pages visited,
                time spent on pages, and other browsing data.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>To send you marketing communications about our products and services</li>
